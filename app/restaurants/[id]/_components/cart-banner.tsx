...
export const CartBanner = ({ restaurant }: CartBannerProps) => {
  ...
  const { products, totalPrice, totalQuantity, totalDelivery } =
  ...
  if (!restaurantHasProductOnCart) {
    return null;
  }

  return (
    <div className="fixed bottom-0 left-0 w-full border-solid border-muted bg-white p-5 pt-3 shadow-md">
